...
Addons and translations are from the [Scratch Addons browser extension](https://scratchaddons.com/). Feature requests should be sent [upstream](https://github.com/ScratchAddons/ScratchAddons/issues), but bug reports should be opened [here](https://github.com/turbowarp/scratch-gui/issues/) first incase it's a bug caused by TurboWarp.
